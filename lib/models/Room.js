...
var jsonpatch = require ('json-diff-patch/jsonpatch');
var jsondiff  = require ('json-diff-patch/jsondiff');
...
Room.prototype.diffAndPatch = function (after) {
  var diff = jsondiff.diff (this.lines, after);
  jsonpatch.apply (this.lines, diff);
